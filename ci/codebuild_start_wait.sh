...
echo "Start checking status for build...(https://console.aws.amazon.com/codesuite/codebuild/$ACCOUNT_ID/projects/$PROJECT_NAME/build/$BUILD_ID/?region=us-east-1)"
